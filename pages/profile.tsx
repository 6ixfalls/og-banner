...
export default function Profile() {
    ...
    useEffect(() => {
        fetch(`https://api.lanyard.rest/v1/users/${userId}`).then(async (res) =>
                    ...
                    <div className="self-end mx-12 absolute top-[668px] uppercase font-bold text-2xl text-slate-300 items-end flex flex-col">
                        ...
                        <div className="w-full flex flex-row my-4">
                            ...
                            <img
                                width="130px"
                                className="ml-6 inline-block rounded-xl"
                                src="https://cdn.discordapp.com/app-assets/383226320970055681/565945769320775680.webp"
                            />
                            <img
                                width="52px"
                                className="absolute bottom-[0.25rem] right-[-0.75rem] rounded-full"
                                src="https://cdn.discordapp.com/app-assets/383226320970055681/565945770067623946.webp"
                            />
                        </div>
                    </div>
                ) : null
                ...
                <div className="flex flex-col">
                    ...
                    {socials.map((object, i) => (
                        <div
                            ...
                            key={i}
                        >
                            <span className={`icon-${object.key} mr-2`} />
                            {object.value}
                        </div>
                    ))}
                </div>
